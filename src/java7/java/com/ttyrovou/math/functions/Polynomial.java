    ...
    public String toString() {
        ...
        for (int i = coefficients.length - 1; i >= 0; i--) {
            ...
            if (i != 0 && i != coefficients.length - 1 && i != 1) {
                if (!(coefficients[i].getIm().equals(com.ttyrovou.math.numbers.Fraction.ZERO) || coefficients[i].getRe().equals(com.ttyrovou.math.numbers.Fraction.ZERO))) {
                    builder.append("+(")
                ...
                if (!(coefficients[i].getIm().equals(com.ttyrovou.math.numbers.Fraction.ZERO) || coefficients[i].getRe().equals(Fraction.ZERO))) {
                    builder.append("+(")
                            .append(coefficients[i])
                            .append(")")
                            .append("x");
